...
/// @custom:dev-run-script jointSavings_metadata.json
...
contract JointSavings {
    ...
    */
    ...
    // Code to handle the plain ether transaction goes here (if needed).
    // This function will be called when the contract receives ether without a specific function call
     }
}